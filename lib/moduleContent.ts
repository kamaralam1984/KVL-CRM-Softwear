...
export const MODULE_CONTENT: Record<string, ModuleContent> = {
  ...
  Leads: {
    ...
    seoTitle: "Maxness Leads Management — AI-Powered Lead Capture & Conversion",
    seoDesc: "Maxness's advanced lead management system helps sales teams capture, score, assign, and convert leads 3× faster with AI scoring, automated workflows, and real-time pipeline visibility.",
    ...
    heroText: [
      "In today's hyper-competitive market, the difference between winning and losing a deal often comes down to speed and precision. Maxness's Leads module is engineered for both. From the moment a prospect fills out your web form, connects with you on LinkedIn, or gets imported from a CSV file, Maxness instantly creates a rich lead profile, assigns a quality score, and routes the lead to the right sales rep — all in under three seconds.",
    ...
    howItWorks: [
      { num: "01", title: "Capture from Any Source",   desc: "Web forms, landing pages, CSV imports, WhatsApp, email, LinkedIn, and 100+ integrations automatically funnel leads into Maxness. Duplicate detection merges identical records and flags near-duplicates for review." },
      { num: "02", title: "Score, Qualify & Enrich",   desc: "The AI engine scores each lead within seconds. Maxness also enriches profiles with company data, social profiles, and firmographic information — giving your reps a complete picture before they even pick up the phone." },
    ...
    features: [
      ...
      { title: "Mobile Lead Capture & Management", desc: "Capture and manage leads on the go with Maxness's mobile-optimized interface. Scan business cards, log calls, and update statuses from anywhere in the world." },
    ],
    stats: [
  ...
  Customers: {
    ...
    seoTitle: "Maxness Customer Management — 360° Customer Intelligence Platform",
    seoDesc: "Maxness's customer management module provides a complete 360° view of every customer relationship — purchase history, communication logs, health scores, and upsell opportunities in one place.",
    intro: "Your customers are your most valuable asset. Maxness's Customer Management module gives your team a complete 360-degree view of every relationship — from the first purchase to lifetime value — so you can deliver personalized experiences that drive retention, expansion, and advocacy.",
    heroText: [
      "Retaining an existing customer costs five times less than acquiring a new one, yet most businesses still invest the majority of their CRM budget on lead acquisition rather than customer success. Maxness's Customer module is designed to flip that equation. It consolidates every interaction, purchase, support ticket, email, and conversation into a single, unified customer profile that every team member — from sales to finance to support — can access in real time.",
      "The Customer Health Score is one of Maxness's most powerful features. Using a combination of product usage signals, payment behavior, support ticket frequency, NPS survey results, and engagement data, Maxness automatically calculates a health score from 0 to 100 for every account. Customers with declining health scores trigger automatic alerts to their account manager, giving your team the window it needs to intervene before churn becomes inevitable.",
    ...
    benefits: [
      ...
      { title: "Customer Health Scoring",          desc: "Maxness's AI continuously monitors 20+ health indicators and updates each customer's score in real time. Declining scores trigger automated alerts, ensuring your team catches at-risk accounts weeks before renewal conversations — dramatically reducing preventable churn." },
    ...
    howItWorks: [
      ...
      { num: "02", title: "Enrich & Score",            desc: "Maxness enriches the profile with company data, news mentions, and financial signals. The health score algorithm begins tracking behavior immediately, establishing a baseline within the first 30 days." },
      ...
      { num: "04", title: "Grow & Retain",             desc: "Upsell opportunities are surfaced automatically. Renewal workflows begin 90 days before contract end. NPS surveys go out at the right moments. Maxness manages the entire customer lifecycle proactively." },
    ],
    features: [
  ...
  Deals: {
    ...
    seoTitle: "Maxness Deals Management — Advanced Deal Tracking & Revenue Intelligence",
    seoDesc: "Maxness's deals module gives revenue teams complete visibility into every opportunity — deal scoring, competitor tracking, collaborative closing, and revenue forecasting all in one place.",
    intro: "Maxness's Deals module is the command center for your entire revenue operation. Every opportunity, from a $500 SMB contract to a $5M enterprise deal, gets the same level of attention, tracking, and intelligence — ensuring your team never drops the ball on a high-value opportunity again.",
    heroText: [
      "Winning deals in today's market requires more than a good product — it requires perfect execution across a complex, multi-stakeholder buying journey. Maxness's Deals module provides the structure, intelligence, and automation your team needs to move faster, forecast more accurately, and close at a higher rate than the competition. From the moment a deal is created, the system begins tracking time-in-stage, suggesting next actions, and calculating win probability using a machine learning model trained on thousands of closed deals.",
      "Deal scoring is one of the features our customers describe as transformative. Rather than relying on sales reps' subjective gut feelings about deal health, Maxness analyzes engagement signals, response times, stakeholder coverage, competitive mentions, and timeline adherence to produce an objective Deal Score updated in real time. Managers can instantly identify which deals are on track, which are stalling, and which need urgent intervention — without sitting through an hour-long pipeline review call.",
      "Maxness's collaborative deal rooms allow entire teams to work on complex opportunities together. Share collateral, track stakeholder engagement, record competitor intelligence, manage action items, and co-author proposals — all within the deal record. When a rep goes on leave or a deal transfers between team members, the incoming rep has everything they need to continue seamlessly. No more lost context, no more awkward handoffs.",
    ],
    benefits: [
      { title: "AI Deal Scoring & Win Probability", desc: "Maxness's ML model scores every deal from 1–100 based on engagement, stage velocity, competitive signals, and historical patterns. Win probability percentages give managers accurate forecasts and help reps prioritize their energy on closable deals." },
      ...
      { title: "Revenue Forecasting Engine",        desc: "Maxness aggregates deal data, historical close rates, and seasonal trends to generate accurate weekly and monthly revenue forecasts. Finance teams get real-time pipeline visibility that replaces spreadsheet-based forecasting entirely." },
      { title: "Competitor & Objection Tracking",   desc: "Log which competitors are involved in each deal and track the objections raised. Over time, Maxness identifies patterns — which competitors you most often encounter, which objections are most common in specific industries — arming your team with competitive intelligence." },
    ],
    howItWorks: [
    ...
    features: [
      ...
      { title: "E-Signature Integration",          desc: "Send proposals and contracts for e-signature directly from Maxness. Track open rates, completion rates, and get notified the instant a contract is signed." },
      ...
      { title: "Lost Deal Analysis",               desc: "When a deal is lost, capture structured reasons. Maxness analyzes lost deal patterns to identify process improvements, pricing issues, and competitive gaps." },
    ],
    stats: [
  ...
  Pipeline: {
    ...
    seoTitle: "Maxness Sales Pipeline — Visual Kanban Pipeline Management",
    seoDesc: "Maxness's visual sales pipeline gives managers and reps a real-time view of every deal across every stage — with drag-and-drop management, stage analytics, and automated pipeline health alerts.",
    intro: "A well-managed pipeline is the difference between predictable revenue and monthly uncertainty. Maxness's Visual Sales Pipeline gives every stakeholder — from frontline reps to the CFO — a real-time, accurate picture of where deals stand, what's moving, and where revenue is at risk.",
    heroText: [
      "Maxness's pipeline module is built on the belief that great sales management starts with perfect visibility. Our intuitive drag-and-drop Kanban board lets reps move deals between stages in seconds, while the underlying analytics engine tracks every movement, calculates stage conversion rates, and surfaces bottlenecks before they become revenue problems. Whether you manage a single pipeline or 20 parallel pipelines for different product lines or geographies, Maxness handles the complexity with elegance.",
      "Pipeline hygiene is one of the biggest challenges facing sales organizations today. Stale deals, over-inflated pipelines, and forecast inaccuracies erode trust between sales and leadership. Maxness solves this with automated pipeline hygiene tools: deals that haven't been updated in a configurable number of days are automatically flagged, reps receive reminder nudges, and managers see a real-time 'pipeline health score' that reflects the accuracy and freshness of their forecast.",
      "Beyond visualization, Maxness's pipeline analytics give leaders the data they need to coach effectively. Stage-by-stage conversion rates, average time-in-stage, deal velocity trends, and rep-level performance comparisons are all available in real time. Identify which stages lose the most deals, which reps move deals fastest, and which industries have the highest close rates — all from a single analytics dashboard that updates as deals move.",
    ],
    benefits: [
      ...
      { title: "Revenue Forecasting by Stage",      desc: "Apply weighted probability percentages to each stage and Maxness automatically calculates your expected revenue for the current quarter. Adjust weightings based on historical performance and watch your forecast accuracy improve month over month." },
    ],
    howItWorks: [
  ...
  Tasks: {
    ...
    seoTitle: "Maxness Task Management — Sales Activity Tracking & Follow-up Automation",
    seoDesc: "Maxness's task management system keeps your entire sales team organized with smart reminders, automated task creation, priority scoring, and complete activity visibility across all deals and customers.",
    intro: "In sales, execution is everything. The best strategy fails without disciplined follow-through. Maxness's Tasks & Activities module ensures every commitment is captured, every follow-up is scheduled, and every action item reaches completion — keeping your team accountable and your customers delighted.",
    heroText: [
      "Research consistently shows that 80% of sales require five or more follow-up attempts, yet 44% of sales reps give up after just one. Maxness's Task module is designed to eliminate this failure mode entirely. Every task created in Maxness is linked to a specific lead, deal, or customer, giving it full context. Reps see not just what to do, but who it's for, what the last interaction was, and exactly what outcome the task is designed to achieve.",
      "Maxness's intelligent task creation goes beyond manual entry. When a deal moves to a new stage, tasks are automatically created from templates you define. When an automation workflow fires, tasks appear in the right rep's queue. When a customer hasn't been contacted in 30 days, Maxness creates a re-engagement task and assigns it to the account manager. This means your team's daily task list is always populated with the right actions at the right time — without anyone needing to remember to create them.",
      "Managers gain unprecedented visibility into team activity through Maxness's activity dashboard. See exactly how many calls were made, emails sent, meetings held, and tasks completed by each rep each day. Compare activity levels across the team, identify reps who are active but not converting, and distinguish coaching opportunities from capacity issues. The activity data feeds directly into performance reviews, replacing subjective impressions with objective evidence.",
    ],
    benefits: [
      ...
      { title: "Smart Priority Scoring",           desc: "Maxness scores each task by urgency and importance based on deal value, deadline proximity, customer health score, and manager-set priorities. Reps start each day knowing exactly which three tasks will have the biggest revenue impact." },
    ...
    howItWorks: [
      ...
      { num: "02", title: "Receive Smart Reminders", desc: "Maxness sends reminders via email, push notification, and in-app alert — timed perfectly based on the task due date and your working hours. Overdue tasks escalate to managers automatically." },
    ...
    features: [
      ...
      { title: "Calendar Integration",             desc: "Sync tasks and meetings with Google Calendar and Microsoft Outlook. Schedule meetings directly from Maxness and see your full agenda without switching applications." },
  ...
  Finance: {
    ...
    seoTitle: "Maxness Finance Module — Invoicing, Payments & Revenue Tracking for Sales Teams",
    seoDesc: "Maxness's finance module bridges the gap between sales and finance — create and send invoices, track payments, manage expenses, and see real revenue data alongside your CRM pipeline.",
    intro: "Maxness's Finance module eliminates the perpetual handoff between sales and finance. Create invoices, track payments, manage expenses, and generate financial reports without ever leaving your CRM — bringing revenue clarity to your entire organization.",
    heroText: [
      "For most businesses, the journey from closed deal to collected payment involves multiple systems, email threads, manual data re-entry, and painful reconciliation exercises. Maxness's Finance module collapses this entire workflow into a single, elegantly designed interface that lives alongside your deals, customers, and pipelines — making the connection between sales activity and financial outcomes completely transparent.",
      "Professional invoices can be created in under two minutes directly from a closed deal. All customer details, product line items, and pricing are pre-populated from the deal record. Customize the invoice with your branding, add payment terms, apply discounts, and send it via email with a single click. Clients receive a beautifully formatted invoice with a secure payment link — and Maxness tracks every open, every click, and every payment in real time.",
    ...
    benefits: [
      ...
      { title: "Connected Revenue Analytics",      desc: "Bridge the gap between sales pipeline and actual collected revenue. Maxness displays invoiced value, collected revenue, and outstanding balances alongside your pipeline data — giving leadership a single, accurate picture of financial performance without spreadsheet reconciliation." },
      ...
      { title: "Multi-Currency & Tax Support",     desc: "Invoice clients in any currency with automatic exchange rate conversion. Configure tax rates, VAT/GST rules, and regional compliance requirements. Maxness handles the calculations so your finance team stays compliant without manual intervention." },
    ],
    howItWorks: [
    ...
    features: [
      ...
      { title: "Partial Payments & Installments",  desc: "Record partial payments and manage installment plans. Maxness tracks the outstanding balance and adjusts payment reminders accordingly." },
  ...
  Reports: {
    ...
    howItWorks: [
      { num: "01", title: "Connect Your Data",      desc: "All Maxness modules feed data automatically into the analytics engine. No integrations needed — your CRM, pipeline, finance, and customer data are all connected from the moment you start using the platform." },
  ...
  "WhatsApp CRM": {
    ...
    seoTitle: "Maxness WhatsApp Integration — Business WhatsApp CRM with Broadcasts & Automation",
    seoDesc: "Maxness's WhatsApp integration lets sales and support teams manage customer conversations, send broadcast campaigns, set up auto-replies, and track engagement — all from inside your CRM.",
    intro: "WhatsApp is where your customers are. With 2 billion active users and open rates exceeding 95%, it's the highest-engagement communication channel available to businesses today. Maxness's WhatsApp module brings the full power of WhatsApp Business directly into your CRM — transforming it from a messaging app into a complete revenue and relationship channel.",
    heroText: [
      "In most businesses today, WhatsApp conversations happen in isolation — on individual reps' personal phones, invisible to managers, disconnected from customer records, and impossible to track or measure. Maxness solves this entirely. By integrating with the official WhatsApp Business API, Maxness creates a shared, managed WhatsApp inbox where every message is logged, every conversation is linked to a customer or lead record, and every interaction becomes part of the complete relationship history.",
      "Broadcast campaigns through Maxness's WhatsApp module reach up to 100,000 contacts simultaneously with personalized messages that go out as individual conversations — not group chats. Personalization tokens pull data from your CRM records so every customer receives a message that feels like it was written specifically for them. Campaign analytics track delivery rates, read receipts, response rates, and conversion metrics in real time, making WhatsApp campaigns fully measurable for the first time.",
      "Auto-reply rules transform your WhatsApp into a 24/7 customer service channel. Define keyword triggers and Maxness automatically responds with the right message — whether that's answering an FAQ, sending a product brochure, booking a callback, or routing the conversation to a live agent. During business hours, conversations are intelligently routed to available team members based on their specialty, workload, and language. After hours, the automation handles everything seamlessly.",
    ],
    benefits: [
    ...
    howItWorks: [
      { num: "01", title: "Connect WhatsApp Business", desc: "Connect your WhatsApp Business number via the official Meta Business API. One-time setup takes under 30 minutes. Your number stays yours — Maxness just powers it." },
  ...
  "Email Marketing": {
    ...
    benefits: [
      ...
      { title: "A/B Testing & Optimization",       desc: "Test subject lines, sender names, send times, content, and CTAs against each other with statistical significance controls. Maxness automatically routes traffic to the winning variant and provides detailed performance comparisons to inform future campaigns." },
      { title: "Advanced Deliverability Management", desc: "Maxness actively monitors and protects your sender reputation. Domain authentication, bounce processing, spam score analysis, and list hygiene tools keep your emails out of spam folders and in front of your customers — protecting the investment you've made in building your list." },
    ],
    howItWorks: [
      ...
      { num: "02", title: "Segment Your Audience",  desc: "Use Maxness's CRM data to build hyper-targeted send lists. Filter by industry, deal stage, lead score, engagement history, geography, or any custom attribute. Save segments for reuse across future campaigns." },
      { num: "03", title: "Schedule & Send",        desc: "Send immediately or schedule for optimal timing. Maxness's send-time optimization analyzes recipient engagement history and schedules each email for the time that individual is most likely to open it." },
  ...
  Automation: {
    ...
    features: [
      ...
      { title: "Webhook & API Actions",            desc: "Fire webhooks to external systems, trigger Zapier automations, call Make scenarios, or hit your own APIs — connecting Maxness to your entire technology stack." },
  ...
  "AI Assistant": {
    ...
    seoTitle: "Maxness AI Assistant — Intelligent Sales Co-Pilot & Revenue Intelligence",
    seoDesc: "Maxness's AI Assistant provides real-time recommendations, deal insights, email drafting, lead scoring explanations, and predictive revenue analysis — powered by advanced machine learning.",
    intro: "Maxness's AI Assistant is not a chatbot — it's an intelligent co-pilot that augments every member of your revenue team. From explaining why a deal score changed to drafting a personalized follow-up email to predicting which customers are at risk of churning, the AI Assistant delivers actionable intelligence exactly when it's needed.",
    heroText: [
      "Artificial intelligence in CRM has a reputation for being impressive in demos and disappointing in practice. Maxness's approach is fundamentally different. Rather than building a generic AI assistant trained on public internet data, our AI is fine-tuned on your CRM's actual data — your deals, your customers, your win/loss patterns, your communication history. This means every insight, recommendation, and prediction is grounded in the specific reality of your business, not generic best practices.",
  ...
  "Team Mgmt": {
    ...
    seoTitle: "Maxness Team Management — Sales Team Performance, Roles & Collaboration",
    seoDesc: "Maxness's team management module gives sales leaders complete visibility into team performance — rep scorecards, quota tracking, role-based access, collaboration tools, and capacity planning.",
    intro: "Great sales results are built by great teams. Maxness's Team Management module gives leaders the tools to hire, organize, motivate, measure, and develop their revenue team — all within the same platform where their reps work every day.",
    heroText: [
      "Managing a sales team without data is like coaching a sports team without a scoreboard. You know generally what's happening, but you can't optimize specific performance gaps without objective evidence. Maxness's Team Management module provides that scoreboard — a real-time, multi-dimensional view of individual and team performance that replaces intuition with intelligence. From activity metrics to pipeline contribution to quota attainment to customer success scores, every dimension of sales performance is captured, analyzed, and visualized.",
      "Role-based access control is one of the most critical features in an enterprise CRM, and Maxness's implementation is the most granular available in its class. Super Admins define plan-level feature access. Admins configure role-based section permissions. Team leads can further restrict or grant access at the individual user level. This three-tier permission architecture means every team member sees exactly what they need — nothing more, nothing less — reducing information overload and protecting sensitive data across large, complex organizations.",
      "Team collaboration features transform Maxness from a personal productivity tool into a genuinely collaborative platform. Shared deal rooms, internal comments on any record, @mentions that trigger notifications, collaborative proposal creation, and team-level performance goals all foster the communication and transparency that high-performing sales organizations depend on. When everyone is working from the same information, with the same context, towards the same goals, team performance consistently exceeds the sum of individual contributions.",
    ],
    benefits: [
    ...
    howItWorks: [
      ...
      { num: "02", title: "Set Goals & Benchmarks",   desc: "Define performance benchmarks for every role — activity minimums, deal velocity targets, quota attainment expectations. Maxness measures actual performance against these benchmarks in real time, flagging underperformance before it impacts quarterly results." },
      { num: "03", title: "Monitor & Coach",          desc: "Weekly team performance summaries land in every manager's inbox. Drill into individual rep performance from the team dashboard. Schedule coaching sessions, log development actions, and track improvement over time — all within Maxness." },
      { num: "04", title: "Recognize & Retain",       desc: "Team leaderboards, achievement badges, and goal-completion celebrations keep reps engaged. High-performer recognition feeds into talent retention strategies — and Maxness's attrition risk indicators flag disengaged team members before they resign." },
    ],
    features: [
  ...
  "Smart Insights": {
    ...
    seoTitle: "Maxness Smart Insights — AI-Powered Business Intelligence & Predictive Analytics",
    seoDesc: "Maxness's Smart Insights module combines real-time dashboards, predictive analytics, anomaly detection, and benchmarking to give revenue leaders the intelligence they need to make faster, better decisions.",
    intro: "Smart Insights is Maxness's highest-level intelligence layer — a continuously learning analytical engine that synthesizes data from every module to surface the insights, patterns, and predictions that matter most to your business right now.",
    heroText: [
    ...
    benefits: [
      ...
      { title: "Proactive Anomaly Detection",      desc: "Define normal performance ranges and Maxness's anomaly detection engine monitors every key metric continuously. The moment a metric moves outside its expected range — email deliverability drops, churn rate spikes, pipeline velocity slows — you receive an automated alert with context and suggested actions." },
    ...
    howItWorks: [
      { num: "01", title: "Continuous Data Collection", desc: "Smart Insights ingests data from every Maxness module in real time — deals moving, leads converting, emails opening, customers churning, invoices being paid. No data preparation or ETL processes required." },
